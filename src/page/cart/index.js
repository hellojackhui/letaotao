/**
 * Created by JackHui on 2017/8/6.
 */
'use strict';
require('./index.css');
...
var page = {
    ...
    renderCart:function (data) {
        ...
        //生成Html
        var cartHtml=_ltt.renderHtml(templateIndex,data);
